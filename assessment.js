...
var bob = {height:"6ft",age:24,hair:{style:"spikey",color:"brown"},presidentOfTheUnitedStates:false,likes:["apples","bananas","cherries"]};
...
var snake = {
	...
	runs: 'legless'
        ...
        for (var prop in snake){ snake[prop] = "s"};
...
function removeItem(arr,str){  //redo***
...
function makeChatMessage(message,author){
    ...
    return obj = {message:message,author:author,timestamp:new Date()};
}
